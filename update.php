...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (move_uploaded_file($_FILES['file']['tmp_name'], $filepath)) {
        // Update file data
        $sql = "UPDATE files SET filename='$filename', filetype='$filetype', filepath='$filepath', description='$description' WHERE id=$id";
...
<div class="form-container">
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <textarea name="description" rows="4" required><?php echo $file['description']; ?></textarea>
